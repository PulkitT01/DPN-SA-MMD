...
from DCN_network_mmd import DCN_network
...
class DPN_SA_Deep:
    ...
    def test_DCN(self, iter_id, np_covariates_X_test, np_covariates_Y_test, dL,
        ...
        # using SAE
        model_path_e2e = "./DCNModel/SAE_E2E_DCN_model_iter_id_{0}_epoch_100_lr_0.0001_mmd.pth".format(iter_id)
        model_path_stacked_all = "./DCNModel/SAE_stacked_all_DCN_model_iter_id_{0}_epoch_100_lr_0.0001_mmd.pth".format(
            iter_id)
        model_path_stacked_cur = "./DCNModel/SAE_stacked_cur_DCN_model_iter_id_{0}_epoch_100_lr_0.0001_mmd.pth".format(
            iter_id)
    ...
    def __train_propensity_net_NN(self, ps_train_set,
        ...
        train_parameters_NN = {
            ...
            "model_save_path": "./Propensity_Model/NN_PS_model_iter_id_"
                               + str(iter_id) + "_epoch_{0}_lr_{1}_mmd.pth",
        ...
        eval_parameters_train_NN = {
            ...
            "model_path": "./Propensity_Model/NN_PS_model_iter_id_{0}_epoch_{1}_lr_0.001_mmd.pth"
        ...
        model_path = "./DCNModel/NN_DCN_model_iter_id_" + str(iter_id) + "_epoch_{0}_lr_{1}_mmd.pth"
    ...
    def __train_propensity_net_SAE(self,
        ...
        model_path_e2e = "./DCNModel/SAE_E2E_DCN_model_iter_id_" + str(iter_id) + "_epoch_{0}_lr_{1}_mmd.pth"
    ...
    def __train_propensity_net_LR(self, np_covariates_X_train, np_covariates_Y_train,
        ...
        data_loader_dict_LR = dL.prepare_tensor_for_DCN(np_covariates_X_train,
                                                        ...
                                                        ps_score_list_LR,
                                                        is_synthetic)
        model_path = "./DCNModel/LR_DCN_model_iter_id_" + str(iter_id) + "_epoch_{0}_lr_{1}_mmd.pth"
    ...
    def __train_propensity_net_LR_Lasso(self, np_covariates_X_train, np_covariates_Y_train,
        ...
        data_loader_dict_LR_lasso = dL.prepare_tensor_for_DCN(np_covariates_X_train,
                                                              ...
                                                              is_synthetic)
        model_path = "./DCNModel/LR_Lasso_DCN_model_iter_id_" + str(iter_id) + "_epoch_{0}_lr_{1}_mmd.pth"
    ...
    def __test_DCN_NN(self, iter_id, np_covariates_X_test, np_covariates_Y_test, dL, device,
        ...
        ps_eval_parameters_NN = {
            ...
            "model_path": "./Propensity_Model/NN_PS_model_iter_id_{0}_epoch_50_lr_0.001_mmd.pth".format(iter_id),
            "input_nodes": input_nodes
        }
        ...
        data_loader_dict_NN = dL.prepare_tensor_for_DCN(np_covariates_X_test,
                                                        ...
                                                        ps_score_list_NN,
                                                        is_synthetic)
        model_path = "./DCNModel/NN_DCN_model_iter_id_{0}_epoch_100_lr_0.0001_mmd.pth".format(iter_id)
    ...
    def __test_DCN_LR(self, np_covariates_X_test, np_covariates_Y_test, LR_model, iter_id, dL, device,
        ...
        model_path = "./DCNModel/LR_DCN_model_iter_id_{0}_epoch_100_lr_0.0001_mmd.pth".format(iter_id)
        ate_pred, att_pred, bias_att, atc_pred, policy_value, \
        policy_risk, err_fact = \
    ...
    def __test_DCN_LR_Lasso(self, np_covariates_X_test, np_covariates_Y_test, LR_model_lasso,
        ...
        model_path = "./DCNModel/LR_Lasso_DCN_model_iter_id_{0}_epoch_100_lr_0.0001_mmd.pth".format(iter_id)
